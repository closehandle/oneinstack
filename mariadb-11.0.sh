...
apt install libmimalloc2.0 libncurses5 -y || exit $?

pushd /usr/local
wget -O mariadb-11.0.2-linux-systemd-x86_64.tar.gz https://mirrors.gigenet.com/mariadb/mariadb-11.0.2/bintar-linux-systemd-x86_64/mariadb-11.0.2-linux-systemd-x86_64.tar.gz || exit $?
tar xf mariadb-11.0.2-linux-systemd-x86_64.tar.gz && rm -f mariadb-11.0.2-linux-systemd-x86_64.tar.gz
mv -f mariadb-11.0.2-linux-systemd-x86_64 mariadb
